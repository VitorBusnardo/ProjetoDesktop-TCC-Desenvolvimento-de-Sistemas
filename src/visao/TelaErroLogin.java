...
public class TelaErroLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("<html> <br> Você digitou algum </br> <br> <center> dado errado! </center> </br> </html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaErroLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaErroLogin().setVisible(true);
            }
        });
    }
