...
public class TelaErroAlterar extends javax.swing.JFrame {

    public TelaErroAlterar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel12.setText("<html> <br> A mudança por algum </br> <br> <center> motivo falhou! </center> </br> </html>");
        ...
        btnConfirmar.setText("Algo Errado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaErroAlterar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaErroAlterar().setVisible(true);
            }
        });
    }
