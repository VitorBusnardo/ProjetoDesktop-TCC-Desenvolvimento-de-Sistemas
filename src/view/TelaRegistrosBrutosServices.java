...
public class TelaRegistrosBrutosServices extends javax.swing.JFrame {
    
    public TelaRegistrosBrutosServices() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRegistrosBrutosServices.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaRegistrosBrutosServices().setVisible(true);
            }
        });
    }
